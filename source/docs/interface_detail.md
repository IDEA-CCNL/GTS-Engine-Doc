...
| `task_type` | str | 根据engine_type选择其支持的任务类型：<br>qiankunding支持三种任务类型 <br>- classification：文本分类 <br> - similarity：句子相似度 <br> - nli：推理任务 <br> bagualu支持的三种任务类型 <br>- classification：文本分类 <br> - ie：信息抽取 <br> - summary：摘要生成 |
